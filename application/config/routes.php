...
$route['admin/rooms/assign/(:num)'] = 'Room/assign/$1';
$route['admin/rooms/give'] = 'Room/give';
$route['admin/rooms/give/(:num)'] = 'Room/give/$1';
$route['admin/rooms/give/search2'] = 'Room/search2';
$route['admin/rooms/give/show2'] = 'Room/show2';
$route['admin/rooms/give/show_by2'] = 'Room/show_by2';
